                                                                  ...
                                                                  Align(
                                                                      ...
                                                                      child: Text(
                                                                          ...
                                                                          textAlign: TextAlign
                                                                              .left,
                                                                          style:
                                                                              AppStyle.txtPoppinsSemiBold22WhiteA700))
                                                                ])))
                                                  ])),
                                          Container(
                                                                              ...
                                                                              itemBuilder: (BuildContext ctx, index) {
                                                                                return InkWell(
                                                                                  ...
                                                                                  child: Card(
                                                                                    ...
                                                                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(KString.size * Dimens.size1)),
                                                                                    child: Stack(
                                                                                      children: [
                                                                                        Container(
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text("+ Add More",
                                                      ...
                                                      style: AppStyle
                                                          ...
                                                          .copyWith(
                                                        color: KColor
                                                            .teal300, // Ganti dengan warna hijau yang diinginkan
                                                      )),
                                                )
                                              ])),
                                      Align(
